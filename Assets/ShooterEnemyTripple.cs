...
public class ShooterEnemyTripple : Enemy
{
    [Header("Test enemy")]
    ...
    void Shoot()
    {
        ...
        for (int i = -1; i < 2; i++)
        {
            GameObject go = LeanPool.Spawn(enemyCard.projectile, shootPoint.position, transform.rotation * Quaternion.AngleAxis(15 * i, Vector3.up));
